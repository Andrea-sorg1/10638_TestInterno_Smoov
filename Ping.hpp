...
typedef void __fastcall (__closure *TPingReply)(System::TObject* Sender, System::TObject* Icmp, int Status);
...
protected:
	...
	unsigned __fastcall GetICMPHandle(void);
...
public:
	...
	virtual int __fastcall Ping(void);
	...
	__property unsigned ICMPDLLHandle = {read=GetICMPHandle, nodefault};
...
//-- var, const, procedure ---------------------------------------------------
static const Shortint PingVersion = 0x72;
