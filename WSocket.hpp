...
#include "IcsLogger.hpp"	// Pascal unit
...
enum TSocketState { wsInvalidState, wsOpened, wsBound, wsConnecting, wsSocksConnected, wsConnected, wsAccepting, wsListening, wsClosed };
#pragma option pop
...
#pragma option push -b-
enum TSocketKeepAliveOnOff { wsKeepAliveOff, wsKeepAliveOnCustom, wsKeepAliveOnSystem };
#pragma option pop

typedef sockaddr_in  TSockAddr;

typedef void __fastcall (__closure *TDataAvailable)(System::TObject* Sender, Word ErrCode);

typedef void __fastcall (__closure *TDataSent)(System::TObject* Sender, Word ErrCode);

typedef void __fastcall (__closure *TSendData)(System::TObject* Sender, int BytesSent);

typedef void __fastcall (__closure *TSessionClosed)(System::TObject* Sender, Word ErrCode);

typedef void __fastcall (__closure *TSessionAvailable)(System::TObject* Sender, Word ErrCode);

typedef void __fastcall (__closure *TSessionConnected)(System::TObject* Sender, Word ErrCode);

typedef void __fastcall (__closure *TDnsLookupDone)(System::TObject* Sender, Word ErrCode);
...
#pragma option push -b-
enum TWSocketOption { wsoNoReceiveLoop, wsoTcpNoDelay, wsoSIO_RCVALL };
#pragma option pop

typedef Set<TWSocketOption, wsoNoReceiveLoop, wsoSIO_RCVALL>  TWSocketOptions;
...
protected:
	...
	int FLingerTimeout;
	TSocketKeepAliveOnOff FKeepAliveOnOff;
	int FKeepAliveTime;
	...
	TDebugDisplay FOnDebugDisplay;
	Classes::TNotifyEvent FOnMessagePump;
	unsigned FThreadId;
	int FSocketSndBufSize;
	int FSocketRcvBufSize;
	Icslogger::TIcsLogger* FIcsLogger;
	virtual void __fastcall SetIcsLogger(const Icslogger::TIcsLogger* Value);
	virtual void __fastcall DebugLog(Icslogger::TLogOption LogOption, const AnsiString Msg);
	virtual bool __fastcall CheckLogOptions(const Icslogger::TLogOption LogOption);
	...
	virtual void __fastcall TryToSend(void);
	...
	virtual void __fastcall InternalAbort(Word ErrCode);
	...
	Byte __fastcall GetReqVerLow(void);
	void __fastcall SetReqVerLow(const Byte Value);
	Byte __fastcall GetReqVerHigh(void);
	void __fastcall SetReqVerHigh(const Byte Value);
	void __fastcall TriggerDebugDisplay(AnsiString Msg);
	...
	virtual void __fastcall TriggerSessionConnectedSpecial(Word Error);
	...
	virtual void __fastcall Do_FD_CONNECT(Messages::TMessage &msg);
	virtual void __fastcall Do_FD_READ(Messages::TMessage &msg);
	virtual void __fastcall Do_FD_WRITE(Messages::TMessage &msg);
	virtual void __fastcall Do_FD_ACCEPT(Messages::TMessage &msg);
	virtual void __fastcall Do_FD_CLOSE(Messages::TMessage &msg);
	virtual void __fastcall DupConnected(void);
...
public:
	...
	virtual int __fastcall SendStr(const AnsiString Str);
	virtual void __fastcall DnsLookup(const AnsiString AHostName);
	virtual void __fastcall ReverseDnsLookup(const AnsiString HostAddr);
	virtual void __fastcall ReverseDnsLookupSync(const AnsiString HostAddr);
	...
	void __fastcall SetKeepAliveOption(void);
	...
	virtual void __fastcall PutDataInSendBuffer(void * Data, int Len);
	void __fastcall PutStringInSendBuffer(const AnsiString Str);
	void __fastcall DeleteBufferedData(void);
	virtual void __fastcall MessagePump(void);
	virtual void __fastcall ThreadAttach(void);
	virtual void __fastcall ThreadDetach(void);
	void __fastcall MessageLoop(void);
	bool __fastcall ProcessMessage(void);
	void __fastcall ProcessMessages(void);
	__property int BufferedByteCount = {read=FBufferedByteCount, nodefault};
	
protected:
	__property Icslogger::TIcsLogger* IcsLogger = {read=FIcsLogger, write=SetIcsLogger};
	...
	__property int SocketSndBufSize = {read=FSocketSndBufSize, nodefault};
	__property int ListenBacklog = {read=FListenBacklog, write=FListenBacklog, nodefault};
	__property Byte ReqVerLow = {read=GetReqVerLow, write=SetReqVerLow, nodefault};
	__property Byte ReqVerHigh = {read=GetReqVerHigh, write=SetReqVerHigh, nodefault};
	...
	__property TSocketKeepAliveOnOff KeepAliveOnOff = {read=FKeepAliveOnOff, write=FKeepAliveOnOff, nodefault};
	__property int KeepAliveTime = {read=FKeepAliveTime, write=FKeepAliveTime, nodefault};
	__property int KeepAliveInterval = {read=FKeepAliveInterval, write=FKeepAliveInterval, nodefault};
	__property TDebugDisplay OnDebugDisplay = {read=FOnDebugDisplay, write=FOnDebugDisplay};
};
...
typedef TCustomSocksWSocket TBaseParentWSocket;
;
...
public:
	...
	virtual int __fastcall SendLine(const AnsiString Str);
...
__published:
	...
	__property ListenBacklog ;
	__property ReqVerLow ;
	__property ReqVerHigh ;
	...
	__property KeepAliveOnOff ;
	__property KeepAliveTime ;
	__property KeepAliveInterval ;
...
typedef int __stdcall (*TWSAIoctl)(int s, unsigned IoControlCode, void * InBuffer, unsigned InBufferSize, void * OutBuffer, unsigned OutBufferSize, unsigned &BytesReturned, Windows::POverlapped Overlapped, void * CompletionRoutine);
...
//-- var, const, procedure ---------------------------------------------------
static const Word WSocketVersion = 0x20d;
...
extern PACKAGE TWSAIoctl FWSAIoctl;
...
extern PACKAGE Byte GReqVerLow;
extern PACKAGE Byte GReqVerHigh;
...
static const unsigned SIO_RCVALL = 0x98000001;
static const unsigned SIO_RCVALL_MCAST = 0x98000002;
static const unsigned SIO_RCVALL_IGMPMCAST = 0x98000003;
static const unsigned SIO_KEEPALIVE_VALS = 0x98000004;
static const unsigned SIO_ABSORB_RTRALERT = 0x98000005;
static const unsigned SIO_UCAST_IF = 0x98000006;
static const unsigned SIO_LIMIT_BROADCASTS = 0x98000007;
static const unsigned SIO_INDEX_BIND = 0x98000008;
static const unsigned SIO_INDEX_MCASTIF = 0x98000009;
static const unsigned SIO_INDEX_ADD_MCAST = 0x9800000a;
static const unsigned SIO_INDEX_DEL_MCAST = 0x9800000b;
extern PACKAGE TCustomWSocket* __DataSocket;
...
extern PACKAGE void * __fastcall WSocket2GetProc(const AnsiString ProcName);
...
extern PACKAGE int __fastcall WSocket_WSAIoctl(int s, unsigned IoControlCode, void * InBuffer, unsigned InBufferSize, void * OutBuffer, unsigned OutBufferSize, unsigned &BytesReturned, Windows::POverlapped Overlapped, void * CompletionRoutine);
